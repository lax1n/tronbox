...
/*
    ...
    Updater: lax1n (github.com/lax1n)
...
library Assert {
    ...
    // The null string: ""
    string memory constant STRING_NULL = "";
    ...
    /*
        ...
        Params:
            ...
            message (string memory) - A message to display if the assertion does not hold.
    */
    event TestEvent(bool indexed result, string memory message);
    ...
    /*
        ...
        Params:
            message (string memory) - A message associated with the failure.
    ...
    */
    ...
    /*
        ...
        Params:
            A (string memory) - The first string.
            B (string memory) - The second string.
            message (string memory) - A message that is sent if the assertion fails.
    ...
    */
    ...
    /*
        Function: notEqual(string memory)
    ...
    */
    ...
    /*
        Function: isEmpty(string memory)

        Assert that a string memory is empty.

        : _stringsEqual(str, STRING_NULL) == true

        Params:
            str (string memory) - The string.
            message (string memory) - A message that is sent if the assertion fails.
    ...
    */
    ...
    /*
        Function: isNotEmpty(string memory)

        Assert that a string memory is not empty.
    ...
    */
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function equal(uint[] arrA, uint[] arrB, string memory message) public returns (bool result) {
    ...
    */
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthNotEqual(uint[] arr, uint length, string memory message) public returns (bool result) {
        uint arrLength = arr.length;
    ...
    */
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthNotEqual(int[] arr, uint length, string memory message) public returns (bool result) {
        uint arrLength = arr.length;
        if (arrLength != arr.length)
            _report(result, "");
        else
    ...
    */
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthNotEqual(address[] arr, uint length, string memory message) public returns (bool result) {
        uint arrLength = arr.length;
        if (arrLength != arr.length)
            _report(result, "");
        else
    ...
    */
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthNotEqual(bytes32[] arr, uint length, string memory message) public returns (bool result) {
        uint arrLength = arr.length;
        if (arrLength != arr.length)
            _report(result, "");
        else
    ...
    /******************************** internal ********************************/
        ...
        /*
            ...
            Params:
                ...
                message (string memory) - The message that is sent if the assertion fails.
        */
    ...
    */
    ...
    /*
        ...
        Returns:
            result (string memory) - The resulting string.
    */
    ...
    */
    ...
    /*
        ...
        Returns:
            result (string memory) - The ASCII byte.
    */
    ...
    /*
        ...
        Returns:
            result (string memory) - "true" if true, "false" if false.
    */
    ...
    /*
    function htoa(address addr) constant returns (string memory) {
    ...
    */
    ...
    /*
        Function: _tag(string memory)

        Add a tag to a string. The 'value' and 'tag' strings are returned on the form "tag: value".

        Params:
            value (string memory) - The value.
            tag (string memory) - The tag.

        Returns:
            result (string memory) - "tag: value"
    */
    ...
    */
    ...
    /*
        ...
        Returns:
            result (string memory) - "tag: _ltoa(value)"
    */
    function _tag(bool value, string memory tag) internal pure returns (string memory) {
        string memory memory nstr = _ltoa(value);
        return _tag(nstr, tag);
    }

    /*
        Function: _appendTagged(string memory)

        Append a tagged value to a string.

        Params:
            tagged (string memory) - The tagged value.
            str (string memory) - The string.

        Returns:
            result (string memory) - "str (tagged)"
    */
    ...
    /*
        ...
        Params:
            tagged0 (string memory) - The first tagged value.
            tagged1 (string memory) - The second tagged value.
            str (string memory) - The string.

        Returns:
            result (string memory) - "str (tagged0, tagged1)"
    */
